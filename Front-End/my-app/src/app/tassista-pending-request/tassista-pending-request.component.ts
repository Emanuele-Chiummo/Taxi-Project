...
@Component({
  selector: 'app-tassista-pending-request',
  templateUrl: './tassista-pending-request.component.html',
  styleUrl: './tassista-pending-request.component.css'
})
export class TassistaPendingRequestComponent {
  ...
  ngOnInit(): void {
    ...
    this.getAllRequestsByState('Richiesta');
  }
